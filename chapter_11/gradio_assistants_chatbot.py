...
with gr.Blocks(css=custom_css) as demo:
    ...
    assistant_logs = gr.Markdown("Assistant Logs", elem_id="assistant_logs", render=False)
    with gr.Row():
        ...
        with gr.Column(scale=8):
            ...
            bot_msg = chat_msg.then(run, [chatbot, assistant_id, assistant_logs], [chatbot, assistant_logs], api_name="assistant_response")
