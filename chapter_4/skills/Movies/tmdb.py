...
class TMDbService:
    ...
    def get_top_movies_by_genre(self, genre_name: str) -> str:
        ...
        if genre_id:
            ...
            filtered_movies = [movie for movie in playing_movies if genre_id in movie['genre_ids']][:10]
    ...
    def get_top_tv_shows_by_genre(self, genre_name: str) -> str:
        ...
        if genre_id:
            ...
            top_rated_shows_endpoint = f"{base_url}/tv/top_rated?api_key={self.api_key}&language=en-US"
            ...
            filtered_shows = [show for show in top_rated_shows if genre_id in show['genre_ids']]
